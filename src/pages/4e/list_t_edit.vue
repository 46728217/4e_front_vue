				...
				<div class="item">
					...
					<div class="body">
						<form enctype="multipart/form-data" method="post">
							...
							<input type="file" name="file" class="upload_h" accept="image/x-png,image/gif,image/jpeg,image/bmp" ></input>
						</form>
					</div>
					<div class="ifooter">
...
export default {
	...
	created: function() {
     ...
     //预览图片
        $("body").on('click', ".t-list-edit li.ok .item .body", function(){
	...
	methods: {
		...
		parentHeight: function() {
			$(window.parent.document).find("iframe").height(($(".t-list-edit").height()+100)+'px');
		},
	}
}
</script>
