...
<template>
	<div class="platform-notbest">
		...
		<div id="container" style="border:1px solid #aaa;">
			<img class="platform" src="/static/4e/platform_1.jpg" >
		...
		<PlatformList :usettype="2"></PlatformList>
    ...
    export default {
        ...
        methods: {
            ...
            parentHeight: function() {
                $(window.parent.document).find("iframe").height(($(".platform-notbest").height()+100)+'px');
            }
        }
    }
</script>
