	...
	$.fn.ZoomMark = function(method){
		...
		this.publicMethods = {
			init:function(options){
                ...
                markStyle='width:30px;height:30px;position:absolute;transform:translate(-50%,-50%);background-image: url(example/assets/pointer.png);background-size: 100%;background-repeat: no-repeat;'
                ...
                if(list){
                    for(var i=0;i<list.length;i++){
                        mContainer.publicMethods.mark(list[i].x,list[i].y);
                    }
				}
			},
